    ...
    <div className="min-h-screen bg-surface flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface-card border border-surface-border rounded-2xl p-8">
          <h1 className="text-xl font-semibold text-tx-primary mb-1">Reset your password</h1>
          ...
          {sent ? (
            <div className="space-y-4">
              <div className="p-4 rounded-xl bg-brand-green/10 border border-brand-green/25">
                <p className="text-tx-primary text-sm font-medium mb-1">Check your inbox</p>
                <p className="text-tx-secondary text-xs leading-relaxed">
                  We sent a password reset link to <span className="text-tx-primary font-medium">{email}</span>.
              ...
              <p className="text-tx-muted text-xs leading-relaxed">
                ...
                <button
                  ...
                  className="text-brand-green hover:text-brand-green-light underline"
                >
